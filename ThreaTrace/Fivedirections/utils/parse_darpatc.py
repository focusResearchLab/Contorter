...
# path_list = ['ta1-cadets-e3-official.json', 'ta1-cadets-e3-official-2.json', 'ta1-theia-e3-official-1r.json', 'ta1-theia-e3-official-6r.json', 'ta1-trace-e3-official-1.json']
# path_list = ['ta1-theia-e3-official-6r.json', 'ta1-trace-e3-official-1.json']
path_list = ['ta1-theia-e3-official-6r.json']
